...
<head>
    ...
    <title>Pages / Verify Email - Deforestation</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Verification Your Email</h5>
                                        <p class="text-center small">Thanks for signing up! Before getting started,
                                    ...
                                    <form class="row g-3" method="POST" action="{{ route('verification.send') }}">
                                        @csrf
                                        <div class="col-12">
                                            <button id="btnlogin" class="btn w-100 fw-bold" type="submit">Resend
                                                Verification Email
                                            </button>
                                        </div>
                                    </form>
                                    ...
                                    <form class="row g-3" method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button id="btnlogin" class="btn w-100 fw-bold" type="submit">
                                          Logout
                                        </button>
                                    </form>
                                </div>
