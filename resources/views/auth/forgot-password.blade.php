...
<head>
    ...
    <title>Pages / Reset Password - Deforestation</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Reset Your Password Account</h5>
                                    ...
                                    <form class="row g-3" method="POST" action="{{ route('password.email') }}">
                                        ...
                                        <div class="col-12">
                                            <button id="btnlogin" class="btn w-100 fw-bold"
