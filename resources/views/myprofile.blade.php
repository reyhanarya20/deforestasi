...
<head>
    ...
    <title>Users / Profile - Deforestation</title>
...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('gfcdashboard') }}">
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('gfcdashboard') }}">Home</a></li>
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    ...
                                    <form method="POST" action="{{ route('myprofile.update') }}">
                                        ...
                                        <div class="row mb-3">
                                            <label for="username" class="col-md-4 col-lg-3 col-form-label">Nick
                                                Name</label>
                                            <div class="col-md-8 col-lg-9">
                                ...
                                <div class="tab-pane fade pt-3" id="profile-change-password">
                                    ...
                                    <form method="post" action="{{ route('password.update') }}" >
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input type="password" class="form-control" name="current_password" id="currentPassword" autocomplete="current-password"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label for="newPassword" class="col-md-4 col-lg-3 col-form-label">New
                                                Password</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="password" type="password" class="form-control" id="new-password" autocomplete="new-password"/>
                                            </div>
                                        </div>
