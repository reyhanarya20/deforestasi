                  ...
                  <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                    ...
                    <form method="POST" action="{{ route('myprofile.update') }}">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                          <input name="alamat" type="text" class="form-control" id="Address" value="{{ Auth::user()->username }}" />
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                          <input name="Nohp" type="text" class="form-control" id="Phone" value="{{ Auth::user()->username }}" />
                        </div>
                      </div>
